...
public interface ServiceRetrofit {
    ...
    @Headers({"entorno: "+ Constantes.ENTORNO_API})
    @POST("cerrarcarton")
    Call<ResponseCerrarCarton> doCerrarCarton(@Body RequestPinado requestPinado);

    @Headers({"entorno: "+ Constantes.ENTORNO_API})
    @POST("cerradocarton")
    Call<ResponseLogin> doCerradoCarton(@Body RequestCerradoCarton requestCerradoCarton);
    ...
    @Headers({"entorno: "+ Constantes.ENTORNO_API})
    @POST("finalizarubicacion")
    Call<ResponseFinUbicacion> doFinUbicacion(@Body RequestFinUbicacion requestFinUbicacion);
    ...
    @Headers({"entorno: "+ Constantes.ENTORNO_API})
    @POST("finauditoria")
    Call<ResponseFinAuditoria> doFinAuditoria(@Body RequestFinUbicacion requestFinAuditoria);
    ...
    @Headers({"entorno: "+ Constantes.ENTORNO_API})
    @POST("tamano")
    Call<ResponseTamano> doTamano(@Body RequestTamano requestTamano);
}
