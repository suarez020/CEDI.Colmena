...
public class Constantes {
    public static final int PERMISO_READ_EXTERNAL_STORAGE = 1;
    public static final int PERMISO_WRITE_EXTERNAL_STORAGE = 2;
    public static final int PERMISO_INTERNET = 3;
    public static final int PERMISO_ACCESS_NETWORK_STATE = 4;
    public static final int PERMISO_ACCESS_WIFI_STATE = 5;

    public static final int CODE_AUDITORIA = 1;
    public static final int CODE_CON_CERRAR_P = 2;
    public static final int CODE_EMPAQUE_RFID = 3;
    ...
    public static final String ACTIVITY_NAVEGAR ="ACTIVITY_NAVEGAR";
    ...
    public static final String ACTIVITY_AUDITORIA = "AUDITORIA";
    public static final String ACTIVITY_CONFIRMAR_CP = "CONFIRMA_CP";
